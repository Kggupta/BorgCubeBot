...
module.exports.run = async (bot, message, args)=>{
  ...
  if (message.author.id != "444998388795179042") return message.channel.send("Im sorry, for the time being this command is only enabled for Keshav Gupta / The Borg (Bot creator) as the command is still very buggy. At the moment, please just follow the format as instructed by MEE6 and I will get to adding your social media account ASAP. Sorry for the inconvenience!")
